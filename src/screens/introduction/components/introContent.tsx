...
export const introduction: IntroductionElement[] = [
    ...
    },
    {
        ...
        description: 'CloutFeed is a user-friendly mobile app that allows users to access DeSo from the convenience of their smartphones. Say goodbye to computer screens! Make the most out of DeSo with the all-new mobile experience'
    },
    {
        title: 'Why CloutFeed?',
        imageUri: require('../../../../assets/intro3.png'),
        description: <Text>
            CloutFeed is the first DeSo mobile application. It is
            {' '}<Text
                onPress={() => Linking.openURL('https://github.com/CloutFeed/mobileApp')}
                style={[{ fontWeight: '500' }, themeStyles.linkColor]}>
                open-source
            </Text> and has been vetted multiple times.{'\n'}{'\n'}CloutFeed maximizes your DeSo experience with countless exclusive features that are just available for CloutFeed's users like CloutTags, post notifications and much more.
        </Text>
    },
    {
        title: 'Let\'s go!',
