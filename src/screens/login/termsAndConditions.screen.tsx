...
export default class TermsConditionsScreen extends React.Component<Props, State> {
    ...
    private _termsAndCondition = `Interpretation and Definitions  
==============================
...
by You on any electronic device, named CloutFeed
...
intern@clouttechnologies.com and include in Your notice a detailed description
...
You can contact our copyright agent via email at intern@clouttechnologies.com.
...
* By email: intern@clouttechnologies.com`;
    ...
    private async onAccept() {
        try {
            await SecureStore.setItemAsync(constants.localStorage_termsAccepted, 'true');
            globals.acceptTermsAndConditions();
        } catch { }
    }

    private handleTermsConditions() {
        if (this._isMounted) {
            this.setState({ areTermsAndConditionsAccepted: !this.state.areTermsAndConditionsAccepted });
        }
    }
